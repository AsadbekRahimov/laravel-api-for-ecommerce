        ...
        @foreach($shopOverviews as $shopOverview)
            ...
            <td>{{ $shopOverview->modified_by }}</td>
                       <td class=" text-center">
                           ...
                           <div class='btn-group'>
                               <a href="{!! route('shopOverviews.show', [$shopOverview->id]) !!}" class='btn btn-light action-btn '><i class="fa fa-eye"></i></a>
                               <a href="{!! route('shopOverviews.edit', [$shopOverview->id]) !!}" class='btn btn-warning action-btn edit-btn'><i class="fa fa-edit"></i></a>
