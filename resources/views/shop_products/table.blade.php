        ...
        @foreach($shopProducts as $shopProduct)
            ...
            <td>{{ $shopProduct->modified_by }}</td>
                       <td class=" text-center">
                           ...
                           <div class='btn-group'>
                               <a href="{!! route('shopProducts.show', [$shopProduct->id]) !!}" class='btn btn-light action-btn '><i class="fa fa-eye"></i></a>
                               <a href="{!! route('shopProducts.edit', [$shopProduct->id]) !!}" class='btn btn-warning action-btn edit-btn'><i class="fa fa-edit"></i></a>
