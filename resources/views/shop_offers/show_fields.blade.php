...
<div class="form-group">
    ...
    <p>{{ $shopOffer->accept }}</p>
</div>

<!-- Active Field -->
<div class="form-group">
    {!! Form::label('active', 'Active:') !!}
    <p>{{ $shopOffer->active }}</p>
</div>

<!-- Shop Catalog Id Field -->
<div class="form-group">
    {!! Form::label('shop_catalog_id', 'Shop Catalog Id:') !!}
    <p>{{ $shopOffer->shop_catalog_id }}</p>
</div>
...
<div class="form-group">
    ...
    <p>{{ $shopOffer->deleted_by }}</p>
</div>

<!-- Deleted Text Field -->
<div class="form-group">
    {!! Form::label('deleted_text', 'Deleted Text:') !!}
    <p>{{ $shopOffer->deleted_text }}</p>
</div>

<!-- Modified At Field -->
<div class="form-group">
    {!! Form::label('modified_at', 'Modified At:') !!}
    <p>{{ $shopOffer->modified_at }}</p>
</div>

<!-- Created By Field -->
<div class="form-group">
    {!! Form::label('created_by', 'Created By:') !!}
    <p>{{ $shopOffer->created_by }}</p>
</div>

<!-- Modified By Field -->
<div class="form-group">
    {!! Form::label('modified_by', 'Modified By:') !!}
    <p>{{ $shopOffer->modified_by }}</p>
</div>
