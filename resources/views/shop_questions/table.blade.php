        ...
        @foreach($shopQuestions as $shopQuestion)
            ...
            <td>{{ $shopQuestion->modified_by }}</td>
                <td width="120">
                    ...
                    <div class='btn-group'>
                        <a href="{{ route('shopQuestions.show', [$shopQuestion->id]) }}" class='btn btn-default btn-xs'>
                            <i class="far fa-eye"></i>
                        </a>
                        <a href="{{ route('shopQuestions.edit', [$shopQuestion->id]) }}" class='btn btn-default btn-xs'>
