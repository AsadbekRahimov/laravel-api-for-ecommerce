...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('barcode', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255,'maxlength' => 255]) !!}
</div>

<!-- Barcode Type Field -->
<div class="form-group col-sm-6">
    {!! Form::label('barcode_type', 'Barcode Type:') !!}
    {!! Form::text('barcode_type', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255,'maxlength' => 255]) !!}
</div>

<!-- Option Combine Field -->
<div class="form-group col-sm-6">
    {!! Form::label('option_combine', 'Option Combine:') !!}
    {!! Form::text('option_combine', null, ['class' => 'form-control']) !!}
</div>

<!-- Option Simple Field -->
<div class="form-group col-sm-6">
    {!! Form::label('option_simple', 'Option Simple:') !!}
    {!! Form::text('option_simple', null, ['class' => 'form-control']) !!}
</div>
