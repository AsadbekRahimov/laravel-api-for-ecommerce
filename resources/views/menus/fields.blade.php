...
<div class="form-group col-sm-6">
    <div class="form-check">
        {!! Form::hidden('inline', 0, ['class' => 'form-check-input']) !!}
        {!! Form::checkbox('inline', '1', null, ['class' => 'form-check-input']) !!}
        {!! Form::label('inline', 'Inline', ['class' => 'form-check-label']) !!}
    </div>
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('json', null, ['class' => 'form-control']) !!}
</div>
