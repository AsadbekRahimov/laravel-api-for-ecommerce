        ...
        @foreach($shopCouriers as $shopCourier)
            ...
            <td>{{ $shopCourier->modified_by }}</td>
                       <td class=" text-center">
                           ...
                           <div class='btn-group'>
                               <a href="{!! route('shopCouriers.show', [$shopCourier->id]) !!}" class='btn btn-light action-btn '><i class="fa fa-eye"></i></a>
                               <a href="{!! route('shopCouriers.edit', [$shopCourier->id]) !!}" class='btn btn-warning action-btn edit-btn'><i class="fa fa-edit"></i></a>
