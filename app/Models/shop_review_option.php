 ...
 * )
 */
class shop_review_option extends Model
{
    use SoftDeletes;

    use HasFactory;

    public $table = 'shop_review_option';
    ...
    public static $rules = [
        ...
        'shop_option_branch_id' => 'nullable|integer',
        'deleted_at' => 'nullable',
