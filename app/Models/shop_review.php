 ...
 * )
 */
class shop_review extends Model
{
    use SoftDeletes;

    use HasFactory;

    public $table = 'shop_review';
    ...
    public static $rules = [
        ...
        'rating_option' => 'nullable|string',
        'text' => 'nullable|string',
        'virtues' => 'nullable|string|max:255',
        'drawbacks' => 'nullable|string|max:255',
