 ...
 * )
 */
class shop_element extends Model
{
    use SoftDeletes;

    use HasFactory;

    public $table = 'shop_element';
    ...
    protected $casts = [
        ...
        'barcode' => 'string',
        'barcode_type' => 'string',
        'option_combine' => 'string',
        'option_simple' => 'string',
        'deleted_by' => 'integer',
        'deleted_text' => 'string',
    ...
    public static $rules = [
        ...
        'option_combine' => 'nullable|string',
        'option_simple' => 'nullable|string',
        'deleted_at' => 'nullable',
