 ...
 * )
 */
class shop_shipment extends Model
{
    use SoftDeletes;

    use HasFactory;

    public $table = 'shop_shipment';
    ...
    protected $casts = [
        ...
        'date' => 'date',
        'date_deliver' => 'date',
        'date_deliver_history' => 'string',
        'shipment_type' => 'string',
        'shop_courier_id' => 'integer',
        'responsible' => 'integer',
        'comment' => 'string',
        'ware_place_ids' => 'string',
        'user_place_ids' => 'string',
        'deleted_by' => 'integer',
        'deleted_text' => 'string',
    ...
    public static $rules = [
        ...
        'date_deliver_history' => 'nullable|string',
        'shipment_type' => 'nullable|string|max:255',
        'shop_courier_id' => 'nullable|integer',
        'responsible' => 'nullable|integer',
        'comment' => 'nullable|string|max:255',
        'ware_place_ids' => 'nullable|string',
        'user_place_ids' => 'nullable|string',
        'deleted_at' => 'nullable',
